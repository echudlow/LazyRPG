...
public class Main {
    public static void main (String[] args) {
        ...
        // Game variables
        String [] enemies = {"Skeleton", "Zombie", "Warrior", "Assassin", "Dragon"};
        ...
        int healAmount = 30;
        int dropChance = 50; // Percentage change for health potion to drop
        ...
        while (running){
            ...
            while (enemyHealth > 0) {
                ...
                if (input.equals("1")) {
                    ...
                    System.out.println("\t> You were hit for " + damageTaken + " in retaliation!");
